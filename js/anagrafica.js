...
(function() {
    ...
    const AnagraficaModule = {
        ...
        saveLayout() {
            ...
            localStorage.setItem('Polaris_anagrafica_layout', JSON.stringify(order));
        },
        ...
        renderGrid() {
            ...
            if (!this.localState.searchQuery) {
                const savedOrder = JSON.parse(localStorage.getItem('Polaris_anagrafica_layout') || '[]');
        ...
        getFilteredContatti() {
            ...
            if (q || !localStorage.getItem('Polaris_anagrafica_layout')) {
