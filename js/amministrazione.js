...
// --- MODIFICATO PER AGGIORNAMENTO STATS DINAMICO ---
// =============================================
...
function renderAmministrazioneListView(container) {
            ...
            <div class="stats-grid">
                <div class="stat-card" style="background-color: #3b82f6; border-color: #2563eb;">
                    <div class="stat-content">
                        ...
                        <div class="stat-value" id="stat-clienti-value" style="color: #ffffff;">-</div>
                ...
                <div class="stat-card" style="background-color: #10b981; border-color: #059669;">
                    <div class="stat-content">
                        ...
                        <div class="stat-value" id="stat-credito-value" style="color: #ffffff;">-</div>
                ...
                <div class="stat-card" style="background-color: #FF204E; border-color: #DC1C44;">
                    <div class="stat-content">
                        ...
                        <div class="stat-value" id="stat-debito-value" style="color: #ffffff;">-</div>
    ...
    // === INIZIO MODIFICA ===
    // Chiama le funzioni per popolare tabella E statistiche
    renderAdminStats.call(app); // Nuova chiamata
...
// === INIZIO MODIFICA: Nuova funzione per aggiornare le statistiche ===
function renderAdminStats() {
    const app = this;
    const nClienti = app.state.data.clients.length;
    const credito = totalCredit.call(app);
    const debito = totalDebit.call(app);

    const clientiValueEl = document.getElementById('stat-clienti-value');
    const creditoValueEl = document.getElementById('stat-credito-value');
    const debitoValueEl = document.getElementById('stat-debito-value');

    if (clientiValueEl) clientiValueEl.textContent = app.formatInteger(nClienti);
    if (creditoValueEl) creditoValueEl.textContent = app.formatCurrency(credito);
    if (debitoValueEl) debitoValueEl.textContent = app.formatCurrency(debito);
}
// === FINE MODIFICA ===
...
function addNewClient() {
    ...
    this.hideFormModal();
    // === INIZIO MODIFICA ===
    // Aggiorna sia statistiche che tabella dopo l'aggiunta
    renderAdminStats.call(this);
    renderClientsTable.call(this);
    // === FINE MODIFICA ===
}
...
function deleteClient(clientId) {
    ...
    this.showConfirm(`Sei sicuro di voler eliminare il cliente<br>"${client.name}"?<br><br>L'azione è irreversibile.`, () => {
        ...
        // === INIZIO MODIFICA ===
        // Aggiorna sia statistiche che tabella dopo l'eliminazione
        renderAdminStats.call(this);
        renderClientsTable.call(this);
        // === FINE MODIFICA ===
    });
...
function addTransactionInline(clientId, type) {
    ...
    // === INIZIO MODIFICA ===
    // Aggiorna le statistiche e la tabella principale
    renderAdminStats.call(app);
    renderClientsTable.call(app);
    // === FINE MODIFICA ===
}
